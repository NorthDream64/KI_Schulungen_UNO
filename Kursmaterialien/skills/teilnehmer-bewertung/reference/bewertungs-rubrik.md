...
1. **Erfüllung der Aufgabenstellung** — Sind alle ausdrücklich geforderten
   ...
   ein gefordertes Element fehlt ganz.)
2. **Fachlich-regulatorische Korrektheit** — Stimmen die normativen Aussagen?
   (EU AI Act, BaFin/MaRisk/BAIT, DSGVO). Faktische Fehler sind ein belastbarer,
   beschwerdesicherer Abzugsgrund.
3. **Praxistauglichkeit / Umsetzbarkeit** — Ist das Ergebnis operativ anwendbar
   (wer tut was bis wann), oder bleibt es bei Absichtserklärungen?
...
- ihn mit einem **wörtlichen Beleg oder einer präzisen Fundstelle** aus der
  Projektarbeit verankern (zitieren statt interpretieren);
- ihn auf die **Aufgabenstellung** zurückbinden („gefordert war …, geliefert
  wurde …");
- **sachlich und nicht wertend** formuliert sein (beschreibt die Lücke, nicht die
  Person).
...
Im Zweifel die **höhere** Bewertung. Mehrdeutigkeit, Unschärfe oder ein
