...
The following proposal has been submitted to AIktivInvest for consideration and funding:
...
**Differentiation TrAIvel Friend must prove:** end-to-end execution including payment and claims; cross-app personalisation from purchase history; a built-in translation agent. **Open question for diligence:** is this a defensible moat against Layla/Mindtrip (already booking live) and the OTAs (inventory + distribution advantage)?
...
- Key risks: payment regulation (PSD2), data protection (GDPR — cross-app purchase data + stored card details), liability for faulty bookings, dependency on OTA inventory/APIs, thin differentiation
