...
- Projektmanagement-Manager: Ihr habt viele Projekte, vor allem vermeintlich agile, die immer wieder nach eigenen Regeln und ohne planbaren Erfolg ablaufen; die KI soll Euch helfen, z.B. über ein LLM feste Standards für Statusberichte, Phasenpläne, Dokumentation usw. zu verankern und den internen wie den externen Projektmitarbeitern als Bot zur Verfügung zu stellen.

Dich beschäftigt vor allem, wie Ihr bei SdT mit den Themen "Datenmanagement", "Tool-Einsatz", "Datenaufbereitung", "Datenqualität", "Datenintegration", "MLOps-Konzepte", "KI-Automatisierung im Betrieb", "Training und Validierung von Modellen", "Testverfahren", "Monitoring" und "Integration von KI-Agenten in Projekte" umgehen wollt. Du bist kein Techniker und Deine Kolleginnen und Kollegen noch weniger — es muss also klar, verständlich, möglichst in Bildern, „business-like" mit ihnen kommuniziert werden. Deine IT-Unterstützung ist eine örtliche IT-Beratung, die aber kaum KI und keine internationale Expertise besitzt.

Ihr habt Microsoft 365 im Einsatz; Eure KI würde aller Voraussicht nach auf Azure betrieben werden.
