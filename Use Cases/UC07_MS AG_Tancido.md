# UC-07 · Material Storage AG und Tancido S.A. — Kontext und Aufgabenpaket
...
Am **1. Juli 2026** ist der Kauf vollzogen: Die **Material Storage AG (MS AG)** hat ihren wichtigsten europäischen Wettbewerber übernommen, die **Tancido S.A.**

Beide Häuser bieten dasselbe Leistungspaar an. Sie **lagern** Petroleumprodukte und Chemikalien ein — darunter die strategischen Reserven der deutschen und der spanischen Regierung sowie Vorprodukte für die Nahrungsmittelindustrie. Und sie erbringen **technischen Service und Instandhaltung** an den zugehörigen Anlagen: Tanks, Pumpen, Rohrleitungen, Mess- und Sicherheitstechnik — teils an eigenen Standorten, teils bei Kunden. Ihre Technikerinnen und Techniker sind typischerweise dann vor Ort, wenn eine Anlage für Wartung oder Generalüberholung ohnehin steht.

Der neue, paritätisch besetzte Vorstand hat das Ziel in einer Formel ausgegeben: **1 + 1 > 2.** Konkret bedeutet das **18 Mio. € jährliche Synergien ab dem dritten Jahr**. Der Integrationsplan soll bis zum **30. Juni 2027** umgesetzt sein.

Die Strategie sieht vor, dass die bestehenden Märkte in Europa gemeinsam bearbeitet werden. Übergangsweise gibt es paritätisch besetzte Führungsmannschaften („Doppelspitze“); innerhalb von zwölf Monaten ist jedoch eine klare Besetzung mit der Führungskraft entweder aus MS oder aus Tancido geplant. Diese offen kommunizierte Tatsache erzeugt beträchtlichen Druck bei den Führungskräften und ihren „alten Teams“.

Du bist **KI-Manager:in der MS AG** und sollst den Integrationsplan aus Sicht des KI-Managements verantworten. Du berichtest an die Leiterin des Integrationsprogramms, die als kommende Vorstandsvorsitzende des vereinigten Unternehmens gilt.
...
| | **MS AG** | **Tancido S.A.** |
|---|---|---|
| Sitz | Duisburg | Valladolid |
| Gegründet | 1978 | 1994 |
| Mitarbeitende | ca. 2.400 | ca. 1.600 |
| Jahresumsatz | ca. 410 Mio. € | ca. 260 Mio. € |
| Märkte | Deutschland, Österreich, Benelux, Polen | Spanien, Portugal |
...
| Arbeitssprachen | Deutsch, Englisch, Polnisch | Spanisch, Portugiesisch, Englisch |

**Was beide gemeinsam haben:** Ein Techniker fährt raus, prüft eine Anlage, schreibt einen Servicebericht und empfiehlt Maßnahmen und Ersatzteile. Aus dem Bericht entsteht ein Angebot. Der Weg vom Bericht zum Angebot ist in beiden Häusern unterschiedlich organisiert — und das fällt in der Integration sofort auf.

---

## 3 · Personen

### Du — KI-Manager:in der Material Storage AG
...
### Jens Röttger — Finanzvorstand Material Storage AG
...
### Material Storage AG — Steuerung ohne viel zu steuern
...
| **OES** · *Ofertas en Segundos* | Erzeugt bei Bedarf Anfragen an Lieferanten, verschickt sie nach Freigabe und konsolidiert die Rückläufe mit einer Erfahrungsschätzung aus vergleichbaren Projekten zu einem unverbindlichen Angebot | Vertrieb, 2024 | Handelt nach außen — die Anfragen gehen an Dritte |
...
**Die Falle, die der Fall stellt:** Wer nur den Einsatzgrad misst, erklärt Tancido zum reiferen Haus. Wer nur die Steuerung misst, erklärt die MS AG zum reiferen. Beides ist falsch, und beide Fehler haben in der Integration unterschiedliche, aber gleich teure Folgen.
...
## Anhang A · Kritische Infrastruktur — optionale Vertiefung
...
## Anhang B · Die Doppelspitze — optionale Zuspitzung

> *Ergänzt Entscheidung 1 und 6 aus Abschnitt 6. Ohne diesen Abschnitt bleibt der Fall eine Sachaufgabe; mit ihm wird er eine Führungsaufgabe.*
